          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 mb-12">
            ...
            <div className="lg:col-span-4">
              ...
              <div className="flex flex-wrap gap-2 mb-5">
                {[
                  { label: '✓ ISO 9001:2015', color: 'text-emerald-400 border-emerald-900/60 bg-emerald-950/30' },
            ...
            <div className="lg:col-span-3">
              ...
              <ul className="space-y-4 mb-5">
                ...
                <li className="flex items-start">
                  ...
                  <a href="tel:02302468230" className="text-gray-400 text-xs font-medium hover:text-white transition-colors">
                    0230-2468230 (Factory)
                  </a>
                </li>
              </ul>

              <div className="border-t border-gray-800 pt-5">
                <span className="block text-[9.5px] text-gray-600 uppercase tracking-widest font-bold mb-3">Direct Sales Lines</span>
                <div className="space-y-2.5">
                  {[
                    { name: 'Shivanand', tel: '+919326615251', display: '+91 93266 15251' },
                    { name: 'Vivekanand', tel: '+919325692630', display: '+91 93256 92630' },
                    { name: 'Somshekhar', tel: '+919370468230', display: '+91 93704 68230' },
                  ].map(({ name, tel, display }) => (
                    <a
                      key={name}
                      href={`tel:${tel}`}
                      className="flex items-center justify-between text-gray-300 hover:text-white text-xs font-semibold group transition-colors"
                    >
                      <span>
                        {display}{' '}
                        <span className="text-gray-500 font-normal">({name})</span>
                      </span>
                      <ArrowUpRight className="w-3 h-3 opacity-0 group-hover:opacity-100 text-brand-accent transition-opacity shrink-0 ml-1" />
                    </a>
                  ))}
                </div>
              </div>
