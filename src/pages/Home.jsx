...
const SECTORS = [
  ...
  { icon: '⚗️', title: 'Specialty Chem.', sub: 'Toll Processing'     },
            ...
            <div className="lg:col-span-7">
              ...
              >
                ...
                <span className="text-gray-300 text-[10.5px] font-bold uppercase tracking-widest font-mono">
                  Textile Dyes &amp; Chemicals Manufacturer
                </span>
              </motion.div>
              ...
              >
                Manufacturers of{' '}
                <span className="block text-gradient-animated mt-1">Textile Dyes &amp; Chemicals.</span>
              </motion.h1>
