...
const Contact = () => {
  ...
  const CONTACTS = [
    { name: 'Mr. Shivanand Patil',  phone: '+91 9326615251', tel: '+919326615251', wa: true,  role: 'Director – Technical' },
    { name: 'Mr. Vivekanand Patil', phone: '+91 9325692630', tel: '+919325692630', wa: true,  role: 'Director – Sales'    },
    { name: 'Mr. Somshekhar Patil', phone: '+91 9370468230', tel: '+919370468230', wa: false, role: 'Director – Ops'      },
  ];
  ...
  return (
    ...
    <Helmet>
      ...
      <script type="application/ld+json">
        {`{"@context":"https://schema.org","@type":"ContactPage","mainEntity":{"@type":"Organization","name":"Indu Dyes","contactPoint":[{"@type":"ContactPoint","telephone":"+91-9326615251","contactType":"Sales","areaServed":"Global"},{"@type":"ContactPoint","telephone":"+91-9325692630","contactType":"Sales","areaServed":"Global"}]}}`}
      </script>
    </Helmet>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div className="w-full">
                    ...
                    <div className="space-y-2.5">
                      {/* Landline */}
                      <div className="flex items-center justify-between bg-bg-secondary border border-gray-100 rounded-xl px-4 py-2.5">
                        <span className="text-xs text-text-secondary font-medium">Factory Landline</span>
                        <a href="tel:02302468230" className="text-xs font-bold text-text-primary hover:text-brand-primary transition-colors">
                          0230-2468230
                        </a>
                      </div>
                      {/* Personal contacts */}
