...
const MILESTONES = [
  ...
  },
  {
    ...
    icon: Globe, color: 'text-emerald-600', border: 'border-emerald-400', bg: 'bg-emerald-50',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <div className="bg-white rounded-xl border border-gray-100 p-4">
              <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-3">Direct Factory Desk</p>
              <div className="space-y-2">
                <a href="tel:+919881235243" className="flex items-center justify-between group">
                  <span className="text-xs text-text-secondary font-medium">Factory Contact</span>
                  <span className="text-xs font-bold text-brand-primary group-hover:underline">+91 98812 35243</span>
                </a>
              </div>
            </div>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="mb-14 flex flex-col md:flex-row md:items-end md:justify-between gap-4">
            ...
            <div className="flex items-center gap-3 bg-surface-dark border border-gray-800 rounded-xl px-5 py-3 shrink-0">
              ...
              <div>
                <span className="block text-xs font-bold text-white">Quality Assured</span>
                <span className="text-[10px] text-gray-400 font-semibold">Standard Operating Procedures</span>
              </div>
            </div>
          </div>
